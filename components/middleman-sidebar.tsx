...
export default function MiddlemanSidebar() {
  ...
  return (
    <>
      ...
      >
        {/* Logo */}
        <Link href="/dashboard/middleman" className="h-20 flex items-center px-6 border-b border-gray-200 hover:bg-gray-50 transition-colors">
          <img
        ...
        <div className="px-4 py-4 border-t border-gray-200">
          <div className="px-4 py-3 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl">
            <p className="text-xs font-semibold text-gray-600 mb-1">Middleman Paneli</p>
            <p className="text-xs text-gray-500">Adaylarınızı yönetin</p>
          </div>
        </div>
      </aside>
